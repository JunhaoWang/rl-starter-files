...
if __name__ == '__main__':
    ...
    file = open('stateToIndex_jesuit.pkl', 'rb')
    stateToIndex = pickle.load(file)
    file = open('indexToState_jesuit.pkl', 'rb')
    ...
    f = open('stateToIndex_jesuit_out_{}.pkl'.format(testType), 'wb')
    pickle.dump(stateToIndex, f)

    f = open('indexToState_jesuit_out_{}.pkl'.format(testType), 'wb')
