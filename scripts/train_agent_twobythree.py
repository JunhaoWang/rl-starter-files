...
if __name__ == '__main__':
    ...
    file = open('stateToIndex_twobythree.pkl', 'rb')
    ...
    f = open('stateToIndex_twobythree_out_{}.pkl'.format(testType), 'wb')
    pickle.dump(stateToIndex, f)

    f = open('indexToState_twobythree_out_{}.pkl'.format(testType), 'wb')
