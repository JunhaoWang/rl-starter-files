...
if __name__ == '__main__':
    ...
    file = open('stateToIndex_supergrid.pkl', 'rb')
    stateToIndex = pickle.load(file)
    file = open('indexToState_supergrid.pkl', 'rb')
    ...
    f = open('stateToIndex_supergrid_out_{}.pkl'.format(testType), 'wb')
    pickle.dump(stateToIndex, f)

    f = open('indexToState_supergrid_out_{}.pkl'.format(testType), 'wb')
